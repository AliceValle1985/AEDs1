...
int mostrar7(int x, int quantidade)
{
    if(x > 0)
    {
        if (quantidade % 7 == 0)
        {
            mostrar7(x - 1, quantidade + 7);
            printf("\n%d", quantidade);
        }
    }
}
...
{
    int x = 0;
    printf("\nDigite a quantidade de multiplos de 7:");
    scanf("%d", &x);
    getchar( );
    while(x <= 0)
    {
        printf("\nTem que ser uma quantidade maior que zero. Tente novamente: ");
        scanf("%d", &x);
        getchar( );
    }
    if(x > 0)
    {
        printf("Quantidade de multiplos de 7: ");
        mostrar7(x, 7);
        printf("\n");
    }
}//end method_12
...
int trem13(int x, int quantidade)
{
     if (x > 0)
      {
         printf("\n%d\n", quantidade);
         trem13(x - 1, quantidade + 7);
      }
}
void method_13()
{
...
/*) Incluir um método recursivo (0614) para
ler um valor inteiro do teclado e chamar procedimento recursivo para
mostrar essa quantidade em valores decrescentes da sequência: ... 1/28 1/21 1/14 1/7 1.*/

int trem14(int x, int quantidade)
{
     if (x > 0)
      {
         trem14(x - 1, quantidade + 7);
         printf("\n1 / %d", quantidade);
      }
}
void method_14()
{
    int x = 0;
    printf("\nDigite a quantidade de numeros fracionados por 7: ");
    scanf("%d", &x);
    getchar( );
    while(x <= 0)
    {
    ...
    if(x > 0)
    {
        printf("\nQuantidade de numeros fracionados por 7: ");
        x = x - 1;
        trem14(x, 7);
        printf("\n1");
    }
...
int trem15(int x, int a, int quantidade)
{
    if(x > 0)
    {
        printf("%d\n", a);
        trem15(x - 1, a + quantidade, quantidade + 2);
    }
}
void method_15()
{
...
float trem16(int x, int a, double quantidade)
{
    if(x > 0)
    {
        quantidade = quantidade + (1.0 / a);
        printf("%d / %d\n", 1, a);
        trem16(x - 1, a + 7, quantidade);
        return (quantidade);
    }
}
void method_16()
...
void trem17 (char palavra[], int x)
{
...
void method_18 ( )
{
    ...
    scanf("%s", palavra); 
    x = trem18(palavra, 0);
    printf("%s%d", "Quantidade de numeros pares na string: ", x);
} 

int trem19(char palavra[], int x)
{
    int cont = 0;
    if (x < strlen (palavra)) 
    {
...
void method_19 ( )
{
    ...
    scanf("%s", palavra); 
    x = trem19(palavra, 0);
    printf("%s%d", "Quantidade de letras maiores que K na string: ", x);
...
int method20b(int x)
{
    ...
    {
        return method20b(x - 1) + method20b(x - 2);
    }
}
void trem20(int x)
{
    ...
    printf("Termos pares da série de Fibonacci: ");
...
{   
    int x = 0;
    printf("Digite quantos termos pares quer descobrir de Fibonacci: ");
    scanf("%d", &x); 
    getchar(); 
    trem20( x );
    printf("\n");
}
int somaexponencialpar ( int x, int n, int exp)
{
    if (exp > n) 
    {
        return 0;
    ...
    else 
    {
        ...
        return termo + somaexponencialpar(x, n, exp + 1);
    }
}
...
void method_21()
{
    ...
    scanf("%d", &n);
    printf("Resultado: %d", somaexponencialpar(x, n, exp));
    
}

double method22a(int a, int n)
{
    if (a > n)
    {
        return 0;
    ...
    else
    {
        ...
        return (double)a / den + method22a(a+1, n);
    }
}
void method_22()
{
    ...
    scanf("%d", &n);
    double resultado = 1 + method22a(1, n);
    printf("O resultado da série para %d termos = %lf\n", n, resultado);
}
int main(void)
{
    int x = 0;
    printf ( "%s\n", "Exemplo0622 - Programa = v0.0" );
