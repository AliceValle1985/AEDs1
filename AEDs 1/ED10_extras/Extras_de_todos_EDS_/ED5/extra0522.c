...
{
    int a = 7;
    int b = IO_readint("\nDigite o numero adcionado: ");
    IO_printf("\nSoma dos Quadrados: %d \n", method_19a(a, b));
    IO_pause ( "Apertar ENTER para continuar" );
} 
double method_20a (int x, double y)
{
    int numerador = 1;
    int denominador = 6;
    double soma = 0.0;
...
void method_20 ( )
{
    ...
    int y = IO_readint("\nDigite o numero que ira adcionar: ");
    IO_printf("%s%f\n", "\nSoma dos inversos e naturais: \n", method_20a (x, y)); 
    IO_pause ( "Apertar ENTER para continuar" );
}
...
void method_22() 
{
    ...
    if (n <= 0)
    {
        printf("\nN tem que ser maior que 0");
        
    }
    else
    {
    printf("\nO resutlado de %d repetições é: %lf\n", n, fatorialn2(n));
    }
}
int main(void)
{
     int opcao = 0;
    printf ( "%s\n", "Exemplo0522 - Programa = v0.0" );
