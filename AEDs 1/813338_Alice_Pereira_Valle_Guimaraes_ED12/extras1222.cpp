...
*/
    ...
    Matrix <int> int_matrix(1, 1, 0);
    int_matrix.freadmatrixfromfile ( "DADOS1.TXT" );
    teste = int_matrix.searchRows(search);
    if(teste)
    {
        cout << " e existe na matrix.\n";
    }
    else if(!teste)
    {
        cout << "\nO numero " << search << " não existe na matrix.\n";
    }
}
void method19()
...
*/
    ...
    Matrix <int> int_matrix(1, 1, 0);
    int_matrix.freadmatrixfromfile ( "DADOS1.TXT" );
    teste = int_matrix.searchColumns(search);
    if(teste)
    {
        cout << " e existe na matrix.\n";
    }
...
void method21()
{
    ...
    Matrix <int> int_matrix(1, 1, 0);
    int_matrix.freadmatrixfromfile ( "DADOS1.TXT" );
    teste = int_matrix.extra1();
    int_matrix.print();
    if(teste)
    {
        cout << "\nA matrix condiz com as outras dadas no exercicio.\n";
    }
    else if(!teste)
    {
        cout << "\nA matrix não condiz com as outras dadas no exercicio.\n";
    }
}
void method22()
{
...
int main ( int argc, char** argv )
{
    ...
    do
    {
        ...
        cout << " 17 - Metodo 17 " << endl;
        cout << " 18 - Metodo 18 " << endl;
        cout << " 19 - Metodo 19 " << endl;
        cout << " 20 - Metodo 20 " << endl;
        cout << " 21 - Metodo 21 " << endl;
        cout << " 22 - Metodo 22 " << endl;
        // ler do teclado
