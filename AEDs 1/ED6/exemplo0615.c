...
int trem15(int x, int quantidade)
{
    /*) Incluir uma função recursiva (0615) para
calcular a soma dos primeiros valores ímpares positivos começando no valor 7.
